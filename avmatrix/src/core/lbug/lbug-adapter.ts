 ...
 * an exclusive lock on the LadybugDB file (e.g. `avmatrix analyze` or
 * `avmatrix serve` running at the same time).
 */
 ...
 * database is busy (e.g. `avmatrix analyze` holds the write lock).
