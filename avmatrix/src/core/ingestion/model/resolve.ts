 ...
 *
 * Strategy summary (full docs in avmatrix-shared/mro-strategy.ts):
 ...
 *
 * @see avmatrix-shared/mro-strategy.ts § 'ruby-mixin'
...
export const lookupMethodByOwnerWithMRO = (
  ...
  // See avmatrix-shared/mro-strategy.ts § 'ruby-mixin' for full strategy docs.
